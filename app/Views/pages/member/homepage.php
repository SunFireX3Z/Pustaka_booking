...
<body class="bg-slate-100 text-slate-800">
    ...
    <!-- Full Width Banner Tanpa Teks -->
    <?php 
    $banner_image = $web_profile['banner_image'] ?? null;
    $banner_class = $banner_image ? "bg-cover bg-center" : "bg-gradient-to-r from-indigo-600 to-purple-600";
    ?>
    <div class="relative w-full <?= $banner_class ?>" style="padding-top:30%; <?php if($banner_image): ?>background-image: url('<?= base_url('uploads/profile/' . $banner_image) ?>');<?php endif; ?> background-size: cover; background-position: center;">
